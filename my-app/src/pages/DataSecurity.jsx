...
// const ctaClass =
//   "inline-flex items-center gap-2 px-6 py-3 border border-[#e53e2d] text-[#e53e2d] font-bold text-xs tracking-widest uppercase hover:bg-[#e53e2d] hover:text-white transition-colors duration-200";
...
//       {/* Vestmark-style 3-column grid with images */}
...
//               >
//                 <div className="mb-6 flex justify-center md:justify-start h-44">
//                   <img
//                     src={item.image}
//                     alt={item.title}
...
//                   Data{" "}
//                   <span className="text-[#e53e2d]">{item.accent}</span>
//                 </h3>
...
//       {/* CompuCode-style detail rows (image left, text right) */}
//       {serviceSections.map((section, index) => (
//         <section
//           key={section.accent}
//           className={`py-20 md:py-24 px-6 ${index % 2 === 0 ? "bg-white" : "bg-[#fafafa]"}`}
//         >
...
//                 Data <span className="text-[#e53e2d]">{section.accent}</span>
//               </h3>
