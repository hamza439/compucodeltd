...
// const APP_IMG = "https://compucodeltd.com/images/blobs/data-center.png";
...
//        We are a team with enormous skills in hardware setups, methodology of IT business processes, server consolidation and virtualization to transform your datacenter and reduce your IT CAPEX. This involves converting specific physical hardware pieces to logical items like virtual machines and virtual storage drives, while leveraging on our partnership with global innovators to implement converged infrastructure, engineered systems to gain throughput and speed in infrastructure – application communication thereby increasing IT productivity and speed in response to business requests.

// We integrate cloud computing concepts and network virtualization to give you a quicker go-to-market strategy with an overall reduction in OPEX. This delivers automation and elasticity in application integration.
// Finally, we work closely with you on your business initiative to improve your customer experience with an underline factor that makes your data center more relevant and useful to the way that a business wants to work.
...
if (typeof document !== "undefined" && !document.getElementById("dc-fonts")) {
    ...
    <div style={BODY} className="bg-white">
      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-20 sm:py-24 md:py-32 text-center">
          ...
          <h1
            className="text-3xl sm:text-4xl text-nowrap md:text-5xl lg:text-6xl text-white mb-8"
            style={HEADING}
          >
            Data Center Transformation
          </h1>
          ...
          <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="relative w-full max-w-sm sm:max-w-md">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f0f0f] p-6 sm:p-8 min-h-[260px] sm:min-h-[320px] flex flex-col items-center justify-center">
                <img
                  src={APP_IMG}
                  alt="Data Center Transformation"
                  className="w-full max-w-[220px] sm:max-w-xs object-contain mb-5 sm:mb-6"
                />
                <div className="flex items-center gap-2 text-white/90">
                  <Cpu className="w-4 h-4 sm:w-5 sm:h-5 text-[#e53e2d]" />
                  <span
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 items-center">
          ...
          <div className="md:col-span-7">
            ...
            >
              We are a team with enormous skills in hardware setups, methodology
              of IT business processes, server consolidation and virtualization
              to transform your datacenter and reduce your IT CAPEX. This
              involves converting specific physical hardware pieces to logical
              items like virtual machines and virtual storage drives, while
              leveraging on our partnership with global innovators to implement
              converged infrastructure, engineered systems to gain throughput
              and speed in infrastructure – application communication thereby
              increasing IT productivity and speed in response to business
              requests.
            </p>
            <h3
              ...
              style={HEADING}
            >
              We integrate cloud computing concepts and network virtualization
              to give you a quicker go-to-market strategy with an overall
              reduction in OPEX. This delivers automation and elasticity in
              application integration. Finally, we work closely with you on
              your business initiative to improve your customer experience with
              an underline factor that makes your data center more relevant and
              useful to the way that a business wants to work.
            </h3>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 border border-[#e53e2d] text-[#e53e2d] text-xs tracking-widest uppercase hover:bg-[#e53e2d] hover:text-white transition-colors duration-200"
