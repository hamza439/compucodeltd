        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-[#fafafa]">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#752921] text-white text-xs sm:text-sm font-semibold rounded-md hover:bg-black transition-colors mb-8 sm:mb-10"
                style={soraHeading}
              >
                Learn More
                <ArrowRight size={16} />
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-center">
            ...
            <div className="md:col-span-7">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-5 sm:px-6 py-3 border border-[#752921] text-[#752921] font-bold text-xs tracking-widest uppercase hover:bg-[#752921] hover:text-white transition-colors duration-200"
                style={soraHeading}
              >
                Get Started Now
                <ArrowRight size={16} />
