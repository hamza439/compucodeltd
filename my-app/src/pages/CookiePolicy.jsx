...
//       { name: "irclickid", duration: "30 days", description: "The Impact platform sets this cookie to securely store referral information essential for accurately processing and attributing user referrals made through affiliate links." },
//       { name: "tpclickid", duration: "30 days", description: "The Tapfiliate platform sets this cookie to securely store referral information essential for accurately processing and attributing user referrals made through affiliate links." },
//     ],
//   },
//   {
//     id: "functional",
...
// // ─────────────────────────────────────────────
// //  COOKIE TABLE (responsive: card on mobile, table on desktop)
// // ─────────────────────────────────────────────
...
//               >
//                 <td className="px-4 py-3 font-mono text-[11px] text-red-800 font-semibold break-all align-top">
//                   {c.name}
//                 </td>
...
//             <span className="inline-block text-[10px] bg-red-100 text-red-700 px-2 py-0.5 rounded-full mb-2">
//               {c.duration}
//             </span>
...
//             <span className="text-white text-xs sm:text-sm">Powered by CookieYes</span>
//           </div>
//         </div>
//       </div>
...
//           <span
//             className="text-red-700 text-lg leading-none transition-transform duration-200"
...
//                   onClick={() => scrollTo(s.id)}
//                   className={`text-left text-sm px-3 py-2 rounded-md transition-all ${
//                     s.label.startsWith("↳") ? "pl-6 text-gray-500" : ""
//                   } ${
//                     activeSection === s.id
//                       ? "bg-red-50 text-red-700 font-semibold border-l-2 border-red-700"
//                       : "text-gray-600 hover:text-red-700 hover:bg-gray-50"
...
//             </p>
//             <button className="mt-4 inline-flex items-center gap-2 bg-red-700 hover:bg-red-800 text-white text-sm font-medium px-5 py-3 rounded-lg transition-colors">
//               🍪 Manage Cookie Preferences
//             </button>

//             <p className="mt-6 text-sm text-gray-700 leading-relaxed">
//               In addition to this, different browsers provide different methods to block and delete cookies. You can change the settings of your browser to block/delete the cookies. Listed below are the links to the support documents on how to manage and delete cookies from the major web browsers:
//             </p>
...
//                     target="_blank"
//                     rel="noreferrer"
//                     className="text-red-700 underline hover:text-red-800 break-all text-xs"
//                   >
//                     {url}
//                   </a>
//                 </li>
...
//             <span className="text-red-700 font-semibold">CookieYes</span> Cookie
//             Policy Generator. © Compucode LTD. All rights reserved.
//           </div>
//         </main>
//       </div>
//      <Footer />
      ...
      <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="lg:hidden sticky top-[64px] z-40 bg-white border-b border-gray-200 px-4 py-3">
          <button onClick={() => setTocOpen((o) => !o)} className="flex items-center justify-between w-full text-sm font-semibold text-gray-700" style={{ fontFamily: "'Sora', sans-serif" }}>
            <span>🍪 Jump to Section</span>
            <span className="text-red-700 text-lg leading-none transition-transform duration-200" style={{ transform: tocOpen ? "rotate(180deg)" : "rotate(0deg)" }}>▾</span>
          </button>
          {tocOpen && (
            <nav className="mt-3 flex flex-col gap-1 pb-2">
              {tocSections.map((s) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 flex gap-8 lg:gap-10">
          ...
          <aside className="hidden lg:block w-60 xl:w-64 shrink-0">
            <div className="sticky top-24">
              ...
              <nav className="flex flex-col gap-1">
                {tocSections.map((s) => (
                  <button key={s.id} onClick={() => scrollTo(s.id)}
                    className={`text-left text-sm px-3 py-2 rounded-md transition-all ${s.label.startsWith("↳") ? "pl-6" : ""} ${activeSection === s.id ? "bg-red-50 text-red-700 font-semibold border-l-2 border-red-700" : "text-gray-600 hover:text-red-700 hover:bg-gray-50"}`}>
                    {s.label}
                  </button>
                ))}
              </nav>
          ...
          <main className="flex-1 min-w-0 space-y-12 sm:space-y-14">
              ...
              <ul className="mt-4 space-y-2">
                {[
                  ...
                  <li key={name} className="flex items-start gap-2 text-sm">
                    ...
                    <span className="text-gray-700 font-medium w-32 shrink-0">{name}:</span>
                    <a href={url} target="_blank" rel="noreferrer" className="text-red-700 underline hover:text-red-800 break-all text-xs">{url}</a>
                  </li>
                ))}
              </ul>
              <p className="mt-5 text-sm text-gray-500">
            ...
            <div className="border-t border-gray-200 pt-8 text-xs text-gray-400 text-center">
              Cookie Policy Generated By <span className="text-red-700 font-semibold">CookieYes</span> Cookie Policy Generator. © Compucode LTD. All rights reserved.
            </div>
          </main>
        </div>
      </div>
