...
//     setActiveSection(id);
//     setTocOpen(false);
//     // account for fixed navbar height (~64px) + a little padding
...
//         style={{
//           background:
//             "linear-gradient(135deg, #7f1d1d 0%, #991b1b 40%, #b91c1c 70%, #dc2626 100%)",
//         }}
//       >
//         {/* Decorative blobs */}
...
//           <p
//             className="text-red-200 text-xs sm:text-sm font-semibold uppercase tracking-widest mb-3"
...
//             We are committed to maintaining robust privacy protections for our
//             users. This policy explains how we collect, use, and safeguard your
//             information.
//           </p>
//           <div className="mt-6 inline-flex items-center gap-2 bg-white bg-opacity-10 border border-white border-opacity-20 rounded-full px-4 sm:px-5 py-2">
...
//           <span
//             className="text-red-700 text-lg leading-none transition-transform"
...
//                   activeSection === s.id
//                     ? "bg-red-50 text-red-700 font-semibold border-l-2 border-red-700"
...
//           {/* Intro Card */}
//           <div className="bg-gray-50 border-l-4 border-red-700 rounded-r-xl p-4 sm:p-6">
//             <p className="text-gray-700 leading-relaxed text-sm">
//               Compucode LTD (The "Company") is committed to maintaining robust
//               privacy protections for its users. Our Privacy Policy is designed
...
//               decisions when using our Service/site.
//             </p>
//           </div>
...
//               Please visit{" "}
//               <a
//                 href="https://compucodeltd.com/about.html"
//                 className="text-red-700 underline hover:text-red-800 break-all"
//               >
...
//             </p>
//             <h3
//               className="font-semibold text-gray-800 mt-6 mb-3"
//               style={{ fontFamily: "'Sora', sans-serif" }}
//             >
...
//                   <span className="shrink-0 w-2 h-2 rounded-full bg-red-600 mt-1.5" />
//                   <span>
//                     <strong className="text-gray-900">{term}</strong> {def}
//                   </span>
//                 </li>
//               ))}
//             </ul>
...
//             <p>
//               We collect{" "}
//               <strong>"Non-Personal Information"</strong> and{" "}
//               <strong>"Personal Information."</strong>
//             </p>
//             <SubSection title="Personal Information">
//               Personal Information you will be providing if you contact us via
//               our website includes your Name, email, contact information
//               including your telephone number or/and contact address, which you
...
//               URLs, platform types, preferences you submit, and number of
//               clicks.
//             </SubSection>
...
//               Information other than your email address. However, in an effort
//               to improve the quality of the Service, we track information
//               provided to us by your browser or by our software application when
//               you view or use the Service, such as the website you came from
//               (known as the "referring URL"), the type of browser you use, the
//               device from which you connected to the Service, the time and date
//               of access, and other information that does not personally identify
//               you.
//               {"\n\n"}
//               We track this information using cookies — small text files which
//               include an anonymous unique identifier. For more information,
//               please read our Cookie Policy on our website.
//             </SubSection>
...
//               personal profile by registering with the Service and entering your
//               email address, and creating a username and a password. By
...
//               13 to sign up for the Service. If you believe we have collected
...
//               the Company.
//               {"\n\n"}
//               We use Personal Information to contact users in response to
//               questions, solicit feedback, provide technical support, and inform
//               users about promotional offers if you opt in. We may also share
//               Personal Information with outside parties if required by law or to
//               protect our users.
//             </SubSection>
//             <SubSection title="Non-Personal Information">
...
//               Information to track trends and analyze use patterns on the Site.
//             </SubSection>
...
//               We further protect your information from potential security
//               breaches by implementing certain technological security measures
//               including encryption, firewalls, and secure socket layer
//               technology. However, these measures do not guarantee that your
//               information will not be accessed, disclosed, altered or destroyed
//               by breach of such firewalls and secure server software. By using
//               our Service, you acknowledge that you understand and agree to
//               assume these risks.
//             </p>
...
//                 <div
//                   key={item}
//                   className="flex flex-col items-center p-3 sm:p-4 bg-red-50 rounded-xl border border-red-100 text-center"
//                 >
//                   <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-red-700 flex items-center justify-center mb-2">
...
//               in each promotional e-mail.
//             </p>
//             <p className="mt-4 text-sm text-gray-700 leading-relaxed">
//               You can also indicate that you do not wish to receive marketing
//               communications from us in the Settings section of the Site. Please
//               note that we may continue to send you administrative emails
...
//               responsible for the privacy practices employed by those websites or
//               the information or content they contain. This Privacy Policy
//               applies solely to information collected by us through the Site and
//               the Service.
//             </p>
//             <p className="mt-4 text-sm text-gray-700 leading-relaxed">
//               We encourage our users to read the privacy statements of other
...
//             <a
//               href="mailto:contactus@compucodeltd.com"
//               className="inline-flex items-center gap-2 mt-4 bg-red-700 hover:bg-red-800 text-white text-sm font-medium px-5 sm:px-6 py-3 rounded-lg transition-colors"
//             >
//               <span>✉</span>
//               contactus@compucodeltd.com
//             </a>
...
//             <strong>30 October 2025</strong>. © Compucode LTD. All rights
//             reserved.
//           </div>
//         </main>
//       </div>
...
//         <div className="w-1 h-6 sm:h-7 rounded-full bg-red-700 shrink-0" />
//         <h2
    ...
    <>
      <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="lg:hidden sticky top-[64px] z-40 bg-white border-b border-gray-200 px-4 py-3">
          ...
          >
            <span>📋 Jump to Section</span>
            <span className="text-red-700 text-lg leading-none transition-transform" style={{ transform: tocOpen ? "rotate(180deg)" : "rotate(0deg)" }}>▾</span>
          </button>
          {tocOpen && (
            <nav className="mt-3 flex flex-col gap-1 pb-2">
              {sections.map((s) => (
                <button key={s.id} onClick={() => scrollTo(s.id)}
                  className={`text-left text-sm px-3 py-2 rounded-md transition-all ${activeSection === s.id ? "bg-red-50 text-red-700 font-semibold border-l-2 border-red-700" : "text-gray-600 hover:text-red-700 hover:bg-gray-50"}`}>
                  {s.label}
                </button>
              ))}
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 flex gap-8 lg:gap-10">
          ...
          <aside className="hidden lg:block w-60 xl:w-64 shrink-0">
            <div className="sticky top-24">
              ...
              <div className="mt-8 p-4 bg-red-50 border border-red-100 rounded-xl">
                <p className="text-xs font-bold text-red-700 mb-1" style={{ fontFamily: "'Sora', sans-serif" }}>Questions?</p>
                <p className="text-xs text-gray-600 leading-relaxed">
                  Contact us at{" "}
                  <a href="mailto:contactus@compucodeltd.com" className="text-red-700 underline break-all">contactus@compucodeltd.com</a>
                </p>
              </div>
            </div>
          </aside>
          ...
          <main className="flex-1 min-w-0 space-y-12 sm:space-y-14">
            ...
            <Section id="who-we-are" title="Who We Are">
              <p>
                Please visit{" "}
                <a href="https://compucodeltd.com/about.html" className="text-red-700 underline hover:text-red-800 break-all">
                  https://compucodeltd.com/about.html
                </a>{" "}
                to read about us.
              </p>
