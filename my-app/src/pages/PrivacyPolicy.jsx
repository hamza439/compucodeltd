      ...
      <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="lg:hidden sticky top-[64px] z-40 bg-white border-b border-gray-200 px-4 py-3">
          ...
          >
            ...
            <span className="text-[#E84A3B] text-lg leading-none transition-transform" style={{ transform: tocOpen ? "rotate(180deg)" : "rotate(0deg)" }}>▾</span>
          </button>
          {tocOpen && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 flex gap-8 lg:gap-10">
          ...
          <main className="flex-1 min-w-0 space-y-12 sm:space-y-14">
            ...
            <Section id="who-we-are" title="Who We Are">
              <p>
                Please visit{" "}
                <a href="https://compucodeltd.com/about.html" className="text-[#E84A3B] underline hover:text-[#E84A3B] break-all">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={term} className="flex gap-3 text-sm text-gray-700">
                    <span className="shrink-0 w-2 h-2 rounded-full bg-[#E84A3B] mt-1.5" />
              ...
              <div className="mt-6 grid grid-cols-3 gap-3 sm:gap-4">
                {["Encryption", "Firewalls", "SSL Technology"].map((item) => (
                  <div key={item} className="flex flex-col items-center p-3 sm:p-4 bg-red-50 rounded-xl border border-red-100 text-center">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#E84A3B] flex items-center justify-center mb-2">
            ...
            <Section id="contact" title="Contact Us">
              ...
              <a href="mailto:contactus@compucodeltd.com"
                className="inline-flex items-center gap-2 mt-4 bg-[#E84A3B] hover:bg-[#E84A3B] text-white text-sm font-medium px-5 sm:px-6 py-3 rounded-lg transition-colors">
                <span>✉</span>
