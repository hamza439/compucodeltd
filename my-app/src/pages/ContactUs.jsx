    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative w-full h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mx-auto mt-4 w-16 h-1 bg-[#E84A3B] rounded-full" />
        </div>
      </div>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white shadow-lg p-8 h-full">
                <h4 className="text-xl font-semibold mb-6 flex items-center gap-2 text-gray-800">
                  <Mail size={20} className="text-[#E84A3B]" /> Send us a message
                </h4>
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <button
                      ...
                      className="mt-6 text-sm text-[#E84A3B] hover:text-[#E84A3B] underline font-medium"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {error && (
                      <div className="bg-red-50 border border-red-200 text-[#E84A3B] text-sm px-4 py-3 rounded">
                        {error}
                      </div>
                    )}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Full Name <span className="text-[#E84A3B]">*</span>
                      </label>
                      <input
                        name="fullName"
                        placeholder="e.g. John Smith"
                        required
                        className="w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-[#E84A3B] focus:ring-1 focus:ring-[#E84A3B] text-sm"
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Email Address <span className="text-[#E84A3B]">*</span>
                      </label>
                      <input
                        name="email"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Telephone <span className="text-[#E84A3B]">*</span>
                      </label>
                      <input
                        name="phone"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Primary Reason for Contacting Us <span className="text-[#E84A3B]">*</span>
                      </label>
                      <select
                        name="reason"
                        required
                        className="w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-[#E84A3B] text-sm text-gray-700 appearance-none bg-white"
                      >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Message <span className="text-[#E84A3B]">*</span>
                      </label>
                      <textarea
                        name="message"
                        placeholder="Tell us how we can help..."
                        required
                        className="w-full border border-gray-300 p-3 rounded h-32 focus:outline-none focus:border-[#E84A3B] focus:ring-1 focus:ring-[#E84A3B] text-sm resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="bg-[#E84A3B] hover:bg-red-700 disabled:bg-red-400 text-white px-8 py-3 rounded font-semibold transition text-sm flex items-center gap-2"
                    >
                      {loading ? (
                        <>
