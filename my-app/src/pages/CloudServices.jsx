      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 items-center">
          ...
          <div className="md:col-span-7">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 border border-[#E84A3B] text-[#E84A3B] font-bold text-xs tracking-widest uppercase hover:bg-[#E84A3B] hover:text-white transition-colors duration-200"
            >
              Get Started Now
              <ArrowRight size={16} />
            </Link>
