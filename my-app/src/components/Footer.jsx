        ...
        <div className="grid lg:grid-cols-12 gap-8 border-b border-gray-200 pb-4">
          ...
          >
            ...
            >
              Learn More
              <span
                className="absolute left-0 -bottom-0.5 h-px bg-[#E84A3B] w-0 transition-all duration-300 group-hover/link:w-full"
              />
            </Link>
          </div>
            ...
            >
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm text-gray-700 hover:text-[#E84A3B] transition-colors duration-200"
                >
          ...
          <ul className="flex flex-wrap gap-x-8 gap-y-2 text-sm text-gray-500">
            {[
              ...
              <li key={label}>
                <Link
                  to={to}
                  className="relative group/nav hover:text-[#E84A3B] transition-colors duration-200"
                >
                  {label}
                  <span className="absolute left-0 -bottom-0.5 h-px bg-[#E84A3B] w-0 transition-all duration-300 group-hover/nav:w-full" />
                </Link>
              </li>
            ))}
          </ul>
          ...
          <div className="flex items-center gap-2">
            {[
              ...
              <a
                ...
                rel="noreferrer"
                aria-label={label}
                className="footer-anim w-9 h-9 rounded-md border border-gray-200 flex items-center justify-center text-gray-500 hover:border-[#E84A3B] hover:text-[#E84A3B] hover:-translate-y-1 hover:scale-110 hover:bg-[#e53e2d08] transition-all duration-300"
                data-anim="sc"
                data-delay={delay}
              >
                {icon}
