      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 py-14">
        ...
        <div className="grid lg:grid-cols-12 gap-12 border-b border-gray-200 pb-12">
          ...
          >
            ...
            <Link
              to="/about"
              className="mt-5 text-[#e53e2d] text-sm font-medium w-fit relative group/link"
            >
              Learn More
              <span
                className="absolute left-0 -bottom-0.5 h-px bg-[#e53e2d] w-0 transition-all duration-300 group-hover/link:w-full"
              />
            </Link>
          </div>
          ...
          <div className="lg:col-span-5 lg:col-start-8 flex flex-col">
            ...
            <div
              ...
              data-delay="0.1s"
            >
              <div className="w-9 h-9 rounded-md border border-gray-200 flex items-center justify-center shrink-0 text-[#e53e2d] transition-all duration-300 hover:border-[#e53e2d] hover:bg-[#e53e2d0f] hover:scale-110">
                <FiMail size={16} />
              </div>
              <div>
                ...
                <a
                  ...
                  className="text-sm text-gray-700 hover:text-[#e53e2d] transition-colors duration-200"
                >
          ...
          <ul className="flex flex-wrap gap-x-8 gap-y-2 text-sm text-gray-500">
            {[
              ...
              <li key={label}>
                <Link
                  to={to}
                  className="relative group/nav hover:text-[#e53e2d] transition-colors duration-200"
                >
                  {label}
                  <span className="absolute left-0 -bottom-0.5 h-px bg-[#e53e2d] w-0 transition-all duration-300 group-hover/nav:w-full" />
                </Link>
              </li>
            ))}
          </ul>
          ...
          <div className="flex items-center gap-2">
            {[
              ...
              <a
                ...
                rel="noreferrer"
                aria-label={label}
                className="footer-anim w-9 h-9 rounded-md border border-gray-200 flex items-center justify-center text-gray-500 hover:border-[#e53e2d] hover:text-[#e53e2d] hover:-translate-y-1 hover:scale-110 hover:bg-[#e53e2d08] transition-all duration-300"
                data-anim="sc"
                data-delay={delay}
              >
                {icon}
